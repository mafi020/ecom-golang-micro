...
type Product struct {
	...
	// Alternative: Complete safety from floating-point errors.
	// $19.99 becomes 1999. $5.00 becomes 500.
	...
	// Represents the *Category struct relationship
	Category      *Category `protobuf:"bytes,9,opt,name=category,proto3,oneof" json:"category,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BatchUpdateProductsRequest struct {
	state         protoimpl.MessageState          `protogen:"open.v1"`
	Updates       map[int64]*UpdateProductPayload `protobuf:"bytes,1,rep,name=updates,proto3" json:"updates,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchUpdateProductsRequest) Reset() {
	*x = BatchUpdateProductsRequest{}
	mi := &file_catalog_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchUpdateProductsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchUpdateProductsRequest) ProtoMessage() {}

func (x *BatchUpdateProductsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_catalog_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchUpdateProductsRequest.ProtoReflect.Descriptor instead.
func (*BatchUpdateProductsRequest) Descriptor() ([]byte, []int) {
	return file_catalog_proto_rawDescGZIP(), []int{6}
}

func (x *BatchUpdateProductsRequest) GetUpdates() map[int64]*UpdateProductPayload {
	if x != nil {
		return x.Updates
	}
	return nil
...
type UpdateProductPayload struct {
	...
	PriceCents    *int64                 `protobuf:"varint,3,opt,name=price_cents,json=priceCents,proto3,oneof" json:"price_cents,omitempty"`
	Stock         *int32                 `protobuf:"varint,4,opt,name=stock,proto3,oneof" json:"stock,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateProductPayload) Reset() {
	*x = UpdateProductPayload{}
	mi := &file_catalog_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateProductPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateProductPayload) ProtoMessage() {}

func (x *UpdateProductPayload) ProtoReflect() protoreflect.Message {
	mi := &file_catalog_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateProductPayload.ProtoReflect.Descriptor instead.
func (*UpdateProductPayload) Descriptor() ([]byte, []int) {
	return file_catalog_proto_rawDescGZIP(), []int{7}
}

func (x *UpdateProductPayload) GetName() string {
	if x != nil && x.Name != nil {
		return *x.Name
	}
	return ""
...
func (x *UpdateProductPayload) GetDescription() string {
	if x != nil && x.Description != nil {
		return *x.Description
	}
	return ""
...
func (x *UpdateProductPayload) GetPriceCents() int64 {
...
func (x *UpdateProductPayload) GetStock() int32 {
...
const file_catalog_proto_rawDesc = "" +
	"\n" +
	"\rcatalog.proto\x12\acatalog\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x96\x02\n" +
	"\bCategory\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04slug\x18\x03 \x01(\tR\x04slug\x12 \n" +
	"\tparent_id\x18\x04 \x01(\x03H\x00R\bparentId\x88\x01\x01\x129\n" +
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x12,\n" +
	"\bproducts\x18\a \x03(\v2\x10.catalog.ProductR\bproductsB\f\n" +
	"\n" +
	"_parent_id\"\xf3\x02\n" +
	"\aProduct\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	...
	"\bcategory\x18\t \x01(\v2\x11.catalog.CategoryH\x01R\bcategory\x88\x01\x01B\x0e\n" +
	"\f_descriptionB\v\n" +
	"\t_category\"#\n" +
	...
	"\bproducts\x18\x01 \x03(\v2\x10.catalog.ProductR\bproducts\"\xc3\x01\n" +
	"\x1aBatchUpdateProductsRequest\x12J\n" +
	"\aupdates\x18\x01 \x03(\v20.catalog.BatchUpdateProductsRequest.UpdatesEntryR\aupdates\x1aY\n" +
	"\fUpdatesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.catalog.UpdateProductPayloadR\x05value:\x028\x01\"\xca\x01\n" +
	"\x14UpdateProductPayload\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tH\x00R\x04name\x88\x01\x01\x12%\n" +
	"\vdescription\x18\x02 \x01(\tH\x01R\vdescription\x88\x01\x01\x12$\n" +
	"\vprice_cents\x18\x03 \x01(\x03H\x02R\n" +
	"priceCents\x88\x01\x01\x12\x19\n" +
	"\x05stock\x18\x04 \x01(\x05H\x03R\x05stock\x88\x01\x01B\a\n" +
	"\x05_nameB\x0e\n" +
	"\f_descriptionB\x0e\n" +
	"\f_price_centsB\b\n" +
	"\x06_stock2\x84\x02\n" +
	...
	"\n" +
	"GetProduct\x12\x1a.catalog.GetProductRequest\x1a\x1b.catalog.GetProductResponse\x12W\n" +
	"\x10BatchGetProducts\x12 .catalog.BatchGetProductsRequest\x1a!.catalog.BatchGetProductsResponse\x12R\n" +
	"\x13BatchUpdateProducts\x12#.catalog.BatchUpdateProductsRequest\x1a\x16.google.protobuf.EmptyB>Z<github.com/mafi020/ecom-golang-micro/proto/catalog;catalogpbb\x06proto3"
...
var file_catalog_proto_goTypes = []any{
	...
	(*BatchGetProductsRequest)(nil),    // 4: catalog.BatchGetProductsRequest
	(*BatchGetProductsResponse)(nil),   // 5: catalog.BatchGetProductsResponse
	(*BatchUpdateProductsRequest)(nil), // 6: catalog.BatchUpdateProductsRequest
	(*UpdateProductPayload)(nil),       // 7: catalog.UpdateProductPayload
	nil,                                // 8: catalog.BatchUpdateProductsRequest.UpdatesEntry
	(*timestamppb.Timestamp)(nil),      // 9: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),              // 10: google.protobuf.Empty
}
var file_catalog_proto_depIdxs = []int32{
	9,  // 0: catalog.Category.created_at:type_name -> google.protobuf.Timestamp
	9,  // 1: catalog.Category.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 2: catalog.Category.products:type_name -> catalog.Product
	9,  // 3: catalog.Product.created_at:type_name -> google.protobuf.Timestamp
	9,  // 4: catalog.Product.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 5: catalog.Product.category:type_name -> catalog.Category
	1,  // 6: catalog.GetProductResponse.product:type_name -> catalog.Product
	1,  // 7: catalog.BatchGetProductsResponse.products:type_name -> catalog.Product
	8,  // 8: catalog.BatchUpdateProductsRequest.updates:type_name -> catalog.BatchUpdateProductsRequest.UpdatesEntry
	7,  // 9: catalog.BatchUpdateProductsRequest.UpdatesEntry.value:type_name -> catalog.UpdateProductPayload
	2,  // 10: catalog.CatalogService.GetProduct:input_type -> catalog.GetProductRequest
	4,  // 11: catalog.CatalogService.BatchGetProducts:input_type -> catalog.BatchGetProductsRequest
	6,  // 12: catalog.CatalogService.BatchUpdateProducts:input_type -> catalog.BatchUpdateProductsRequest
	3,  // 13: catalog.CatalogService.GetProduct:output_type -> catalog.GetProductResponse
	5,  // 14: catalog.CatalogService.BatchGetProducts:output_type -> catalog.BatchGetProductsResponse
	10, // 15: catalog.CatalogService.BatchUpdateProducts:output_type -> google.protobuf.Empty
