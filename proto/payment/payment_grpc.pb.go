...
const (
	...
	PaymentService_CollectCOD_FullMethodName          = "/payment.PaymentService/CollectCOD"
)
...
type PaymentServiceClient interface {
	...
	GetPaymentByOrderId(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*Payment, error)
	CollectCOD(ctx context.Context, in *CollectCODRequest, opts ...grpc.CallOption) (*CollectCODResponse, error)
}
...
func (c *paymentServiceClient) GetPaymentByOrderId(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*Payment, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Payment)
...
func (c *paymentServiceClient) CollectCOD(ctx context.Context, in *CollectCODRequest, opts ...grpc.CallOption) (*CollectCODResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CollectCODResponse)
	err := c.cc.Invoke(ctx, PaymentService_CollectCOD_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	GetPaymentByOrderId(context.Context, *GetPaymentRequest) (*Payment, error)
	CollectCOD(context.Context, *CollectCODRequest) (*CollectCODResponse, error)
...
func (UnimplementedPaymentServiceServer) GetPaymentByOrderId(context.Context, *GetPaymentRequest) (*Payment, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPaymentByOrderId not implemented")
}
func (UnimplementedPaymentServiceServer) CollectCOD(context.Context, *CollectCODRequest) (*CollectCODResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CollectCOD not implemented")
}
...
func _PaymentService_CollectCOD_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CollectCODRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).CollectCOD(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_CollectCOD_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).CollectCOD(ctx, req.(*CollectCODRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CollectCOD",
			Handler:    _PaymentService_CollectCOD_Handler,
		},
	},
